                    ...
                    <a class="dropdown-toggle profile-pic" data-toggle="dropdown" href="#" aria-expanded="false">
                        <a class="dropdown-toggle profile-pic" data-toggle="dropdown" href="#" aria-expanded="false">
                            <div class="avatar-sm avatar avatar-online">
                                <?php if($getStudent->gender == 'Male'): ?>
                                    <img src="../admin/admin_img/male.jpg" alt="image profile" class="avatar-img rounded-circle">
                                <?php elseif($getStudent->gender == 'Female'): ?>
                                    <img src="../admin/admin_img/female.jpg" alt="image profile" class="avatar-img rounded-circle">
                                <?php endif; ?>
                            </div>
                        </a>
                    </a>
